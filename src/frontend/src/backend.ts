...
import type { Category as _Category, Project as _Project, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProjectPhoto(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProjectPhoto(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminCreateProject(arg0: string, arg1: string, arg2: string, arg3: Category, arg4: string, arg5: boolean, arg6: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminCreateProject(arg0, arg1, arg2, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminCreateTestimonial(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminCreateTestimonial(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminDeleteProject(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminDeleteProject(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminDeleteTestimonial(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async adminGetAllContactForms(arg0: string): Promise<Array<ContactForm>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllContactForms(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminUpdateProject(arg0: string, arg1: bigint, arg2: string, arg3: string, arg4: Category, arg5: string, arg6: boolean, arg7: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminUpdateProject(arg0, arg1, arg2, arg3, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg4), arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminUpdateTestimonial(arg0: string, arg1: bigint, arg2: string, arg3: string, arg4: bigint, arg5: string, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminUpdateTestimonial(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProject(arg0: string, arg1: string, arg2: Category, arg3: string, arg4: boolean, arg5: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createProject(arg0, arg1, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTestimonial(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getProjectPhotos(arg0: bigint): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectPhotos(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProjectsByCategory(arg0: Category): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectsByCategory(to_candid_Category_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProject(arg0: bigint, arg1: string, arg2: string, arg3: Category, arg4: string, arg5: boolean, arg6: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProject(arg0, arg1, arg2, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "construction" in value ? Category.construction : "lighting" in value ? Category.lighting : "maintenance" in value ? Category.maintenance : "renovation" in value ? Category.renovation : value;
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.construction ? {
        construction: null
